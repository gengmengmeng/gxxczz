...
namespace MisFrameWork3.Classes.Controller
{
    ...
    { 
        ...
        protected ActionResult QueryDataFromEasyUIDataGrid(string tableName, string dataRangeFields, string conditionFields,Condition externalCondition,string returnFields)
        {
            ...
            {
                if (tableName == "B_CARD_MAKE" || tableName == "B_CARD_STOCK" || tableName == "B_CARD_GRANT" || tableName == "B_MACHINE")
                {
                    //if (tableName == "B_CARD_MAKE") {
                    //    sort = "CREATE_TIME";
                    //}
                    //if (tableName == "B_CARD_STOCK")
                    //{
                    //    sort = "INPUT_TIME";
                    //}
                    //if (tableName == "B_CARD_GRANT")
                    //{
                    //    sort = "RECEIVE_TIME";
                    //}
                    //else {
